package it.xseris.jca.steganography.substitution;
...
public class BaconianCipher {
	...
	/**
	 * Encode the text using Latin Baconian Cipher. Latin Baconian does not
	 * distinguish between i and j and between u and v.
	 * 
	 * @param text
	 *            The text to encode;
	 */
	...
	/**
	 * Decode the text using Latin Baconian Cipher. Latin Baconian does not
	 * distinguish between i and j and between u and v.
	 * 
	 * @param text
	 *            The text to decode;
	...
	/**
	 * Encode the text using Full Baconian Cipher. Full Baconian distinguishes
	 * between i and j and between u and v.
	 * 
	 * @param text
	 *            The text to encode;
	 */
	...
	/**
	 * Decode the text using Full Baconian Cipher. Full Baconian distinguishes
	 * between i and j and between u and v.
	 * 
	 * @param text
	 *            The text to decode;
